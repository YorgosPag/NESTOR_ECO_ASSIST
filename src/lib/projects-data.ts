...
const projects: Project[] = [
  {
    ...
    interventions: [
        { id: 'inter-1', masterInterventionId: 'master-int-1', projectId: 'proj-001', stages: [
        ...
        { id: 'inter-2', masterInterventionId: 'master-int-2', projectId: 'proj-001', stages: [
  ...
  },
  {
    ...
    interventions: [
       { id: 'inter-4', masterInterventionId: 'master-int-2', projectId: 'proj-003', stages: [
  ...
  },
   {
    ...
    interventions: [
        { id: 'inter-5', masterInterventionId: 'master-int-1', projectId: 'proj-004', stages: [
